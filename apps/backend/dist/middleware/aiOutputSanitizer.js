...
function sanitizeAIOutput(content, options = {}) {
    const { maxLength = MAX_OUTPUT_LENGTH, redactPII = true, validateURLs = true, sanitizeHTML = true, } = options;
...
//# sourceMappingURL=aiOutputSanitizer.js.map