...
exports.getToolPromptForAgent = getToolPromptForAgent;
...
function getToolPromptForAgent(agentId) {
    const toolNames = agentTools_1.AGENT_TOOLS[agentId];
    if (!toolNames || toolNames.length === 0)
        return '';
    const toolSchemas = toolNames
        .map(name => agentTools_1.TOOL_DEFINITIONS[name])
        .filter(Boolean)
...
//# sourceMappingURL=masterPrompt.js.map