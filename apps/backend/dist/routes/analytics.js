...
exports.analyticsRouter.get('/ga4/auth', (_req, res) => {
    if (!CLIENT_ID) {
...
exports.analyticsRouter.get('/ga4/callback', async (req, res) => {
...
exports.analyticsRouter.get('/ga4/summary', auth_1.authenticate, async (_req, res, next) => {
    try {
...
exports.analyticsRouter.get('/ga4/top-pages', auth_1.authenticate, async (req, res, next) => {
    try {
        const startDate = req.query.startDate || '7daysAgo';
        const endDate = req.query.endDate || 'today';
        const limit = parseInt(req.query.limit) || 10;
        const pages = await (0, analyticsService_1.getTopPages)(startDate, endDate, limit);
...
exports.analyticsRouter.get('/ga4/traffic-sources', auth_1.authenticate, async (req, res, next) => {
    try {
        const startDate = req.query.startDate || '7daysAgo';
        const endDate = req.query.endDate || 'today';
        const sources = await (0, analyticsService_1.getTrafficSources)(startDate, endDate);
...
exports.analyticsRouter.get('/overview', auth_1.authenticate, async (req, res, next) => {
    try {
        const userId = req.user.userId;
        const [totalMatches, acceptedMatches, pendingMatches, totalIntros, totalConversations, profile,] = await Promise.all([
            prisma.match.count({
