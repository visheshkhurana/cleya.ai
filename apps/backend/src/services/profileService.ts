...
export class ProfileService {
  ...
  async updateProfile(userId: string, data: Record<string, any>) {
    ...
    activityService.recordProfileUpdated(userId, Object.keys(data)).catch(() => {});
