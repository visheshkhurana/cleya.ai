  ...
  return (
    <AppShell>
      ...
      <main className="max-w-3xl mx-auto px-6 lg:px-8 py-16" role="main">
        ...
        {submitted ? (
          <div className="rounded-2xl border border-white/[0.08] p-8 text-center" style={{ background: 'rgba(15,22,41,0.8)' }}>
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: 'rgba(108,99,255,0.15)' }}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#9B95FF" strokeWidth="2"><path d="M20 6L9 17l-5-5" /></svg>
            </div>
            ...
            <Link href="/" className="text-sm font-medium" style={{ color: '#9B95FF' }}>Back to Home</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="rounded-2xl border border-white/[0.08] p-8 space-y-5" style={{ background: 'rgba(15,22,41,0.8)' }}>
            ...
            <div>
              ...
              <select id="contact-subject" value={subject} onChange={e => setSubject(e.target.value)} required
                className="w-full px-4 py-3 rounded-xl text-sm text-white border border-white/[0.08] focus:outline-none focus:border-[#6C63FF] transition appearance-none"
                style={{ background: 'rgba(255,255,255,0.03)' }}>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {[
            ...
            <div key={i} className="text-center p-4 rounded-xl border border-white/[0.06]" style={{ background: 'rgba(15,22,41,0.8)' }}>
