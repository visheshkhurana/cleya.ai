...
const FAQ_ITEMS = [
  { q: 'How does Cleo.ai match me with the right people?', a: 'Cleo uses AI-powered matching that considers your industry, stage, goals, and preferences to find highly relevant connections. Our algorithm achieves 94% match accuracy.' },
  { q: 'Is Cleo.ai free to use?', a: 'Yes, Cleo.ai is free for all members. We offer a premium tier with advanced features for power users.' },
  { q: 'How do I get verified on Cleo?', a: 'You can verify your profile by connecting your LinkedIn account or verifying your work email. Verified profiles get higher match priority.' },
  { q: 'Can I invite others to join Cleo?', a: 'Absolutely! Use your unique referral link from the dashboard to invite colleagues, founders, and investors to join the platform.' },
  { q: 'How do introductions work?', a: 'When you and another member are matched, Cleo facilitates a warm introduction. Both parties must accept the match before contact details are shared.' },
  ...
  { q: 'How quickly will I get a response to my message?', a: 'Our team typically responds within 24-48 hours on business days. For urgent matters, email us directly at hello@cleo.ai.' },
];
    ...
    <div className="min-h-screen" style={{ background: '#0B0918' }}>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border border-white/[0.08] p-8 space-y-5" style={{ background: 'rgba(26,18,48,0.6)' }}>
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label htmlFor="contact-name" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide" style={{ color: '#A09FB5' }}>Name</label>
              ...
              <div>
                <label htmlFor="contact-email" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide" style={{ color: '#A09FB5' }}>Email</label>
            ...
            <div>
              <label htmlFor="contact-subject" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide" style={{ color: '#A09FB5' }}>Subject</label>
            ...
            <div>
              <label htmlFor="contact-message" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide" style={{ color: '#A09FB5' }}>Message</label>
        ...
        <section className="mt-16" aria-label="Frequently asked questions">
          ...
          <div className="space-y-3">
            {FAQ_ITEMS.map((item, i) => (
              <div key={i} className="rounded-xl border border-white/[0.06] overflow-hidden" style={{ background: 'rgba(26,18,48,0.4)' }}>
                <button
                ...
                >
                  ...
                  <svg
                    width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#A09FB5" strokeWidth="2"
                ...
                {openFaq === i && (
                  <div className="px-5 pb-4">
                    <p className="text-sm leading-relaxed" style={{ color: '#A09FB5' }}>{item.a}</p>
                  </div>
                )}
              </div>
            ))}
      ...
      <footer className="border-t border-white/[0.06] mt-16" role="contentinfo">
        <div className="max-w-6xl mx-auto px-6 py-8 text-center">
          <p className="text-xs text-white/30">&copy; 2026 Cleo.ai. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
