    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#0B0918' }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-sm" style={{ color: '#A09FB5' }}>Enter your new password below.</p>
        </div>
        <form onSubmit={handleSubmit} className="rounded-2xl border border-white/[0.08] p-8 space-y-4" style={{ background: 'rgba(26,23,48,0.95)' }}>
          <div>
            <label className="block text-xs font-semibold mb-1.5 uppercase tracking-wide" style={{ color: '#A09FB5' }}>New Password</label>
