    ...
    return (
      <AppShell>
        <div className="text-center max-w-sm">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: '#6C63FF' }}>
    ...
    return (
      <AppShell>
        <div className="text-center max-w-sm">
          ...
          <a href="/" className="inline-block px-6 py-2.5 rounded-lg text-sm font-medium text-white" style={{ background: '#6C63FF' }}>Log In</a>
        </div>
      </AppShell>
    );
  }
    ...
    <AppShell>
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-3" style={{ background: '#6C63FF' }}>
            <span className="text-white text-xl font-bold">C</span>
          </div>
