    ...
    <div className={className}>
      <div className={`relative flex`} ref={dropdownRef}>
        ...
        <input
          ...
          className={`flex-1 min-w-0 px-3 py-2.5 rounded-r-xl border ${borderColor} bg-white/5 text-white placeholder-white/30 text-sm focus:outline-none focus:ring-2 focus:ring-boardy-500 focus:border-transparent disabled:opacity-40 transition-all`}
        />

        {open && (
          <div
            className="absolute top-full left-0 mt-1 w-64 max-h-60 overflow-hidden rounded-xl border border-white/10 bg-[#1A1730] shadow-2xl z-50"
            ref={listRef}
          >
