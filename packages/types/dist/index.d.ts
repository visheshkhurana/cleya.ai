...
export type PersonaType = 'founder' | 'investor' | 'talent' | 'deal_partner' | 'venture_partner' | 'event_participant' | 'advisor' | 'operator' | 'job_seeker' | 'recruiter' | 'freelancer' | 'other';
export type CompanyStage = 'pre_seed' | 'seed' | 'series_a' | 'series_b' | 'series_c_plus' | 'growth' | 'public' | 'bootstrapped';
export type FounderPriority = 'FUNDRAISING' | 'COFOUNDER' | 'HIRING' | 'MARKETING' | 'SALES_BD' | 'VENTURE_PARTNER_HIRE';
export type TalentTargetRole = 'FOUNDING_ENGINEER' | 'FOUNDING_GTM' | 'CHIEF_OF_STAFF' | 'GROWTH_CONTENT' | 'OPEN_APPLICATION' | 'COFOUNDER';
...
export type NotificationEvent = 'match_found' | 'intro_request' | 'intro_accepted' | 'intro_rejected' | 'profile_complete' | 'call_scheduled' | 'call_reminder';
